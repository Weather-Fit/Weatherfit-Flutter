...
class AppTheme {
  final ThemeData lightTheme = ThemeData(
    ...
    textTheme: TextTheme(
      ...
      displayMedium: TextStyle(fontSize: 30.0, fontWeight: FontWeight.w600),
      displaySmall: TextStyle(fontSize: 24.0, fontWeight: FontWeight.w500),
      bodyLarge: TextStyle(fontSize: 20.0, fontWeight: FontWeight.w400),
      bodyMedium: TextStyle(fontSize: 16.0, fontWeight: FontWeight.w300),
      bodySmall: TextStyle(fontSize: 12.0, fontWeight: FontWeight.w100),
    ),
    colorScheme: ColorScheme(
      ...
      tertiary: Color.fromARGB(255, 191, 239, 255),
